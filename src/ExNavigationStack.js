...
class ExNavigationStack extends PureComponent<any, Props, State> {
  ...
  _renderLeftComponentForHeader = (props) => { //eslint-disable-line react/display-name
    ...
    if (routeConfig.navigationBar && typeof routeConfig.navigationBar.renderLeft === 'function') {
      ...
      return null;
    } else if (routeConfig.navigationBar && typeof routeConfig.navigationBar.leftAction === 'object' && routeConfig.navigationBar.leftAction.iconName) {
        const NavigationButton = this.props.navigationButton;
        let la = routeConfig.navigationBar.leftAction
